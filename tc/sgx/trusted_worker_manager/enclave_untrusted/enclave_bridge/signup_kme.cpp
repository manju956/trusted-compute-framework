...
tcf_err_t SignupDataKME::CreateEnclaveDataKME(
    ...
    return result;
}  // SignupDataKME::CreateEnclaveDataKME
...
tcf_err_t SignupDataKME::UnsealEnclaveData(
    ...
    try {
        outPublicEnclaveData.resize(SignupDataSingleton::CalculatePublicEnclaveDataSize());
...
tcf_err_t SignupDataKME::VerifyEnclaveInfoKME(
    ...
    return result;
}  // SignupDataKME::VerifyEnclaveInfoKME
