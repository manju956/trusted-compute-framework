...
SignupInfoWPE::SignupInfoWPE(const std::string& serialized_signup_info) :
...
}  // SignupInfoWPE::SignupInfoWPE

// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
SignupInfoWPE* deserialize_signup_info_wpe(
    const std::string&  serialized_signup_info) {
    return new SignupInfoWPE(serialized_signup_info);
...
std::map<std::string, std::string> CreateEnclaveData(
    ...
    presult = SignupDataWPE::DeserializePublicEnclaveData(
